...
| [Azure Data Explorer source](AZURE_DATA_EXPLORER.md) | Secure ADX authentication, source configuration, bounded KQL, normalization, checkpoints, scheduling, and operations |
